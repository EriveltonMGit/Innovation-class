...
function CardProductsTwo() {
  ...
  const SCROLL_AMOUNT = useMemo(() => (CARD_WIDTH + GAP) * CARDS_PER_VIEW, []);
 ...
 useEffect(() => {
  ...
  const scrollLeft = () => {
    if (currentSlide > 0) {
      ...
      containerRef.current?.scrollTo({ left: newSlide * SCROLL_AMOUNT, behavior: "smooth" });
            ...
            <div className="precos">
              ...
              <div className="area_price">
                <div className="desconto">
                  <p>R$ {produto.precoAnterior.toFixed(2)}</p>
